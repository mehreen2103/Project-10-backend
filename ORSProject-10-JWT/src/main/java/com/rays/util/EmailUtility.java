...
/**
 * EmailUtility is a utility class for sending emails using SMTP. It supports
 * both HTML and plain text messages. SMTP configuration is loaded from the
...
public class EmailUtility {
	...
	/**
	 * Converts a comma-separated list of email addresses into an array of
	 * InternetAddress.
	 * 
