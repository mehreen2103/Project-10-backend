...
public class EmailService {
	...
	public static void sendUserRegistration(String login, String password) {
		...
		msg.setTo(login);
		msg.setSubject("REGISTRATION IS SUCCESSFULL FOR ORSPROJECT-10");
	...
	public static void sendForgotPasswordMail(String login, String password, String firstName, String lastName) {
		...
		EmailMessage msg = new EmailMessage();
		msg.setTo(login);
		msg.setSubject("ORSProject-100 Password Reset");
		msg.setMessage(message);
		msg.setMessageType(EmailMessage.HTML_MSG);
	...
	public static void sendChangePasswordMail(String login, String password, String firstName, String lastName) {
		...
		msg.setTo(login);
		msg.setSubject("ORSProject-10 Password has been changes Successfully.");
		msg.setMessage(message);
		msg.setMessageType(EmailMessage.HTML_MSG);
		EmailUtility.sendMail(msg);
	}
