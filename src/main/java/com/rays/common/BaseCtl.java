...
/**
 * BaseCtl is a generic base controller that provides common CRUD
 * operations for all modules. It handles validation, save, search,
 * get and delete operations using generic DTO, Form and Service classes.
 *
 * @param <F> Form type
 * @param <T> DTO type
...
public class BaseCtl<F extends BaseForm, T extends BaseDTO, S extends BaseServiceInt<T>> {
	...
	/**
	 * Initializes the user context before processing each request.
	 * If no user context is available, a default user is created.
	 */
	@ModelAttribute
	...
	/**
	 * Validates the request data and returns validation errors if any.
	 *
	 ...
	 * @return ORSResponse containing operation status
	 */
	@PostMapping("/save")
	 ...
	 *
	 * @param id record ID
	 * @return ORSResponse containing the requested record
	 */
	@GetMapping("get/{id}")
	...
	/**
	 * Deletes multiple records and returns the updated list.
	 *
	 * @param ids array of record IDs
	 * @param pageNo current page number
	 * @param form search form
	 * @return ORSResponse containing updated records
	 */
	 ...
	 * @return ORSResponse containing search result
	 */
