 ...
 * If the token is invalid or expired, a {@code 401 Unauthorized} response is
 * returned.
 * </p>
 *
 * @author mehreen
...
public class JWTRequestFilter extends OncePerRequestFilter {
	...
	/**
	 * Utility class for JWT operations such as token validation and claim
	 * extraction.
	 */
	@Autowired
	 ...
	 * <li>Loads user details and sets the authentication in
	 * {@link SecurityContextHolder}</li>
	 * <li>Creates a {@link UserContext} and stores it in
	 * {@link UserContextHolder}</li>
	 * </ul>
	 * If the token is invalid, a {@code 401 Unauthorized} response is written and
	 * the filter chain is halted.
	 * </p>
	 *
